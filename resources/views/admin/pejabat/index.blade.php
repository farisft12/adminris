...
<div class="relative min-h-screen bg-slate-50/50 pb-12 font-sans">
    ...
    <div class="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <form action="{{ route('admin.pejabat.update') }}" method="POST" class="space-y-8">
            @csrf
            @method('PUT')
            ...
            <div class="grid gap-8 sm:grid-cols-2">
                ...
                <div class="animate-fade-up rounded-[2.5rem] border border-white bg-white/70 shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-xl p-10 overflow-hidden relative group" style="animation-delay: 100ms">
                    ...
                    <div class="relative">
                        ...
                        <div class="space-y-6">
                            <div class="space-y-2">
                                <label for="bendahara_nama" class="text-[11px] font-black uppercase tracking-widest text-slate-400 ml-1">Nama Lengkap</label>
                                <input id="bendahara_nama" type="text" name="bendahara_nama" required 
                            ...
                            <div class="space-y-2">
                                <label for="bendahara_nip" class="text-[11px] font-black uppercase tracking-widest text-slate-400 ml-1">NIP</label>
                                <input id="bendahara_nip" type="text" name="bendahara_nip" required 
                ...
                <div class="animate-fade-up rounded-[2.5rem] border border-white bg-white/70 shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-xl p-10 overflow-hidden relative group" style="animation-delay: 200ms">
                    ...
                    <div class="relative">
                        ...
                        <div class="space-y-6">
                            <div class="space-y-2">
                                <label for="kabag_nama" class="text-[11px] font-black uppercase tracking-widest text-slate-400 ml-1">Nama Lengkap</label>
                                <input id="kabag_nama" type="text" name="kabag_nama" required 
                            ...
                            <div class="space-y-2">
                                <label for="kabag_nip" class="text-[11px] font-black uppercase tracking-widest text-slate-400 ml-1">NIP</label>
                                <input id="kabag_nip" type="text" name="kabag_nip" required 
