...
<div class="mx-auto max-w-md px-4 py-6 sm:px-6 lg:px-8">
    ...
    <h1 class="mt-2 text-2xl font-bold text-slate-900">Edit Tahun</h1>
    <form method="POST" action="{{ route('admin.years.update', $year) }}" class="mt-6 rounded-xl border border-slate-200 bg-white p-6">
        @csrf
        @method('PUT')
        <div>
